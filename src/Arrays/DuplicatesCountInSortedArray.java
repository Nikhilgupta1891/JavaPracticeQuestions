package com.arrays.findduplicatecountsortedarray;
...
public class DuplicatesCountInSortedArray {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Enter the integer to find in the array: ");
        Integer intToFind = sc.nextInt();
        int count = findDuplicateCount(new int[]{2, 2, 2, 3, 4, 8, 11, 11, 12, 13, 13, 13, 13, 15}, intToFind);
        System.out.println("number of occourances: " + count);
    }
}
